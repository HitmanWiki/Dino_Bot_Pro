...
Price: *$${tokenMarketData.price_usd.toFixed(8)} (${tokenMarketData.price_24h_delta_usd > 0 ? '⬆️' : '⬇️'} ${(tokenMarketData.price_24h_delta_usd * 100).toFixed(2)}%)*
